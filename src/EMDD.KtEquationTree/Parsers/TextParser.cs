...
{
    internal static ParserExpr IdentifierWithSubscript => Try(Map((h1, h2, d, t) => MapToIdenfier(h1, h2, d, t), SingleLetter, LettersOrDigits, U, LettersOrDigits));

    private static MathStatement MapToIdenfier(char h1, string h2, char d, string t)
    {
